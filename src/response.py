...
def response(sentence, context , userID='123', show_details=False):
...
#                                    del context[userID]
                                contextSet = ''
                                if ('context_set' in i):
                                    contextSet = i['context_set']
                                return { 'intent': i['tag'], 'probability': results[0][1], 'response': random.choice(i['responses']), 'context_set':  contextSet, 'context_filter': context_type }
                            else:
                                return;
